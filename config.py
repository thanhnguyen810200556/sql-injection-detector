...
class Config:
    ...
    TRAIN_DATA_PATH = os.path.join(DATA_DIR, 'train', 'Train1.csv')
    TEST_DATA_PATH = os.path.join(DATA_DIR, 'test', 'Test1.csv')
    ...
    RULE_BASED_THRESHOLD = 0.7700  # Ngưỡng riêng cho rule-based
    ML_THRESHOLD = 0.8157        # Ngưỡng riêng cho ML
    COMBINED_THRESHOLD = 0.8500   # Ngưỡng khi kết hợp cả hai

    # Cấu hình kết hợp model
    RULE_WEIGHT = 0.2  # Trọng số cho rule-based 
    ML_WEIGHT = 0.8 # Trọng số cho machine learning 
